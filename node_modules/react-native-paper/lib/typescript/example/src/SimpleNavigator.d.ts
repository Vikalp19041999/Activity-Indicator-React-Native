...
import { DefaultNavigatorOptions, NavigationProp, ParamListBase } from '@react-navigation/native';
...
export declare const createSimpleNavigator: <ParamList extends Record<string, object | undefined>>() => import("@react-navigation/native").TypedNavigator<ParamList, SimpleNavigatorOptions, typeof SimpleNavigator>;
export {};
